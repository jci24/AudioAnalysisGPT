...
1. **Manual Analysis Mode** — Traditional signal inspection with file list, waveform, spectrum, spectrogram, comparison, and analysis inspector panels. Inspector starts collapsed by default.
